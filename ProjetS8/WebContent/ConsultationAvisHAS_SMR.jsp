...
<body>
	...
	<%if (session.getAttribute("avis") != null && session.getAttribute("avisSMRVide")==null){ %>
   		<div class="accordion" id="accordionExample">
   		
  	  <%for (DTO_CIS_bdpm e : (ArrayList<DTO_CIS_bdpm>)session.getAttribute("avis")){ %>		
		    <div class="card">
			      ...
			      <div class="card-body">
			  	      ...
			  	      <div class="form-inline">
				  	      <form class="form-inline" action="Test2" method="get">
							  ...
							  <button type="submit" class="btn btn-outline-dark">Voir les avis SMR de la HAS</button>
							</form>
							<form class="form-inline" action="AvisASMR" method="get">
							  <div class="form-group mb-2">
							    <input type="text" readonly class="form-control plaintext" name="cis" value=<%=e.getAttributes().get("cis") %> hidden>
							  </div>
							  <button type="submit" class="btn btn-outline-dark">Voir les avis ASMR de la HAS</button>
							</form>
