...
<body>
	...
	<form action="Recherche" method="GET">
 	...
 	<%if (session.getAttribute("commercialises") != null && session.getAttribute("commercialisesVide")==null){ %>
   		<div class="accordion" id="accordionExample">
   		
  	  <%for (DTO_CIS_bdpm e : (ArrayList<DTO_CIS_bdpm>)session.getAttribute("commercialises")){ %>		
		    <div class="card">
  	...
  	<%}else if(session.getAttribute("commercialisesVide")==null){ %>
